...
#define STM32_GPIOC_BASE    0x480000800U    //GPIO PortC
...
#define STM32_RCC_AHB1ENR_GPIOCEN       (1 << 2)  //bit 2 IO port C clock

        // GPIO PORT MODE REGISTER

#define STM32_GPIO_MODER_INPUT     (0)     // input pino GPIO
#define STM32_GPIO_MODER_OUTPUT    (1)     // general purpose output mode
#define STM32_GPIO_MODER_ALT       (2)     // alternate mode
