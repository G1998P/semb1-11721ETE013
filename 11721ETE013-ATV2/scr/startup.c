...
void dma1_st0_handler   (void) __attribute__ ((weak, alias("default_handler")));
void dma1_st1_handler   (void) __attribute__ ((weak, alias("default_handler")));
void dma1_st2_handler   (void) __attribute__ ((weak, alias("default_handler")));
void dma1_st3_handler   (void) __attribute__ ((weak, alias("default_handler")));
void dma1_st4_handler   (void) __attribute__ ((weak, alias("default_handler")));
void dma1_st5_handler   (void) __attribute__ ((weak, alias("default_handler")));
void dma1_st6_handler   (void) __attribute__ ((weak, alias("default_handler")));
...
void tim10_handler      (void) __attribute__ ((weak, alias("default_handler")));
...
void dma1_st7_handler   (void) __attribute__ ((weak, alias("default_handler")));
void sdio_handler       (void) __attribute__ ((weak, alias("default_handler")));
void tim5_handler       (void) __attribute__ ((weak, alias("default_handler")));
void spi3_handler       (void) __attribute__ ((weak, alias("default_handler")));
void dma2_st0_handler   (void) __attribute__ ((weak, alias("default_handler")));
void dma2_st1_handler   (void) __attribute__ ((weak, alias("default_handler")));
void dma2_st2_handler   (void) __attribute__ ((weak, alias("default_handler")));
void dma2_st3_handler   (void) __attribute__ ((weak, alias("default_handler")));
void dma2_st4_handler   (void) __attribute__ ((weak, alias("default_handler")));
void otg_handler        (void) __attribute__ ((weak, alias("default_handler")));
void dma2_st5_handler   (void) __attribute__ ((weak, alias("default_handler")));
void dma2_st6_handler   (void) __attribute__ ((weak, alias("default_handler")));
void dma2_st7_handler   (void) __attribute__ ((weak, alias("default_handler")));
...
uint32_t vectors[] __attribute__((section(".isr_vectors"))) =
{
    ...
    (uint32_t)dma1_st0_handler,                 /* 0x0000 006c */
    (uint32_t)dma1_st1_handler,                 /* 0x0000 0070 */
    (uint32_t)dma1_st2_handler,                 /* 0x0000 0074 */
    (uint32_t)dma1_st3_handler,                 /* 0x0000 0078 */
    (uint32_t)dma1_st4_handler,                 /* 0x0000 007c */
    (uint32_t)dma1_st5_handler,                 /* 0x0000 0080 */
    (uint32_t)dma1_st6_handler,                 /* 0x0000 0084 */
    (uint32_t)adc_handler,                      /* 0x0000 0088 */
    (uint32_t)exti9_handler,                    /* 0x0000 009c */
    (uint32_t)tim9_handler,                     /* 0x0000 00A0 */
    (uint32_t)tim10_handler,                    /* 0x0000 00A4 */
    (uint32_t)tim11_handler,                    /* 0x0000 00A8 */
    (uint32_t)tim1_handler,                     /* 0x0000 00AC */
    ...
    (uint32_t)dma1_st7_handler,                 /* 0x0000 00FC */
    (uint32_t)sdio_handler,                     /* 0x0000 0104 */
    (uint32_t)tim5_handler,                     /* 0x0000 0108 */
    (uint32_t)spi3_handler,                     /* 0x0000 010C */
    (uint32_t)dma2_st0_handler,                 /* 0x0000 0120 */
    (uint32_t)dma2_st1_handler,                 /* 0x0000 0124 */
    (uint32_t)dma2_st2_handler,                 /* 0x0000 0128 */
    (uint32_t)dma2_st3_handler,                 /* 0x0000 012C */
    (uint32_t)dma2_st4_handler,                 /* 0x0000 0130 */
    (uint32_t)otg_handler,                      /* 0x0000 014C */
    (uint32_t)dma2_st5_handler,                 /* 0x0000 0150 */
    (uint32_t)dma2_st6_handler,                 /* 0x0000 0154 */
    (uint32_t)dma2_st7_handler,                 /* 0x0000 0158 */
